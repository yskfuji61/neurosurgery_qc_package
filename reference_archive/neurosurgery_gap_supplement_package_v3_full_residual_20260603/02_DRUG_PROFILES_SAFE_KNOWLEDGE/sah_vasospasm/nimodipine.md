...
drug_key: nimodipine
japanese_name: ニモジピン
english_name: nimodipine
generic_name: nimodipine
synonyms: "nimodipine|calcium channel blocker"
drug_class: Ca拮抗薬・SAH国際標準比較対象
domain: sah_vasospasm
priority: A
gap_type: complete_absent_comparison_needed
...
## 1. この薬剤を追加する理由
欧米SAH管理で頻出。国内薬事・採用品を確認せず日本の処方推奨にしてはいけないが、海外文献/RAG比較で必要。
...
```text
ニモジピン OR nimodipine OR nimodipine OR nimodipine|calcium channel blocker
```
