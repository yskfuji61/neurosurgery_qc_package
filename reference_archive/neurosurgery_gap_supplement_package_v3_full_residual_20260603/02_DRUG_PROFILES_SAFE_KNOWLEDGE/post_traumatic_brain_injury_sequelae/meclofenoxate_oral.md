---
drug_key: meclofenoxate_oral
japanese_name: メクロフェノキサート塩酸塩（内服）
generic_name: meclofenoxate hydrochloride
product_examples: "ルシドリール錠等"
...
# メクロフェノキサート塩酸塩（内服）（meclofenoxate hydrochloride）

## Safe RAGでの位置づけ

メクロフェノキサート塩酸塩（内服）は、脳外領域の質問で言及されうる薬剤である。ただし、このファイルは処方推奨ではなく、添付文書・PMDA製品単位情報・院内採用品・保険適用・現在の供給状況を確認させるための安全境界である。
...
頭部外傷後遺症の古い処方・資料で出る。注射剤と内服剤を分ける必要がある。
