---
drug_key: ampicillin
japanese_name: アンピシリン
english_name: ampicillin
generic_name: ampicillin
synonyms: "ABPC|ビクシリン|Listeria coverage"
drug_class: 抗菌薬・髄膜炎/リステリア対応
...
## 1. この薬剤を追加する理由
成人髄膜炎、50歳以上/免疫低下/Listeria文脈で重要。セフトリアキソン/VCMだけでは不十分。
...
```text
アンピシリン OR ampicillin OR ampicillin OR ABPC|ビクシリン|Listeria coverage
```
