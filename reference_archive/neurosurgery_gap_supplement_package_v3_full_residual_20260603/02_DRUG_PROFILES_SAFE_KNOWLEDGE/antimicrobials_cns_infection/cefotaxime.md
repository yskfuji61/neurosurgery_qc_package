---
drug_key: cefotaxime
japanese_name: セフォタキシム
english_name: cefotaxime
generic_name: cefotaxime
synonyms: "CTX|クラフォラン|third generation cephalosporin"
drug_class: 第3世代セフェム・髄膜炎
domain: cns_infection
priority: A
...
## 1. この薬剤を追加する理由
セフトリアキソンと並ぶ髄膜炎主要第3世代セフェム。院内採用差が出るため候補止まりは不十分。
...
1. 「この薬剤はcns_infection文脈で重要だが、製品単位のPMDA確認と院内採用品確認が未完了」と明示する。
...
## 6. 主な参照ソース
- JSGN_MENINGITIS_GL_2014: 細菌性髄膜炎診療ガイドライン2014 治療章  \
  URL: https://www.neurology-jp.org/guidelinem/pdf/zuimaku_guide_2014_08.pdf  \
  使用箇所: 成人細菌性髄膜炎のアンピシリン、バンコマイシン、第3世代セフェム、MEPM等の位置づけ確認  \
  限界: 2014年版。耐性菌動向・JAID/JSC等の最新抗菌薬指針・施設アンチバイオグラムで更新必須。

## 7. PMDA検索クエリ候補

```text
セフォタキシム OR cefotaxime OR cefotaxime OR CTX|クラフォラン|third generation cephalosporin
```
