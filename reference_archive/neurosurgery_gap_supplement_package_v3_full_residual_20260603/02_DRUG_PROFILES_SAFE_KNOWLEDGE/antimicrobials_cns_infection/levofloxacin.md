---
drug_key: levofloxacin
japanese_name: レボフロキサシン
english_name: levofloxacin
generic_name: levofloxacin
synonyms: "LVFX|クラビット|fluoroquinolone"
...
## 1. この薬剤を追加する理由
中枢感染の第一選択ではないが、病棟感染・腎機能・QT・痙攣リスクで脳外RAGに必要。
...
```text
レボフロキサシン OR levofloxacin OR levofloxacin OR LVFX|クラビット|fluoroquinolone
```
