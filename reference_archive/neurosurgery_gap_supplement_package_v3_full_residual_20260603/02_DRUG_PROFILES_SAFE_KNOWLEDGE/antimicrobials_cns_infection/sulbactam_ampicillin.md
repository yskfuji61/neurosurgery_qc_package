---
drug_key: sulbactam_ampicillin
japanese_name: スルバクタム/アンピシリン
english_name: sulbactam/ampicillin
generic_name: sulbactam sodium / ampicillin sodium
synonyms: "SBT/ABPC|ユナシン|誤嚥性肺炎"
drug_class: βラクタマーゼ阻害薬配合ペニシリン
domain: cns_infection_supportive
priority: B
...
# スルバクタム/アンピシリン（sulbactam/ampicillin）

## 1. この薬剤を追加する理由
脳外病棟の誤嚥性肺炎・術後感染で頻出。髄膜炎標準薬と混同しない。
...
1. 「この薬剤はcns_infection_supportive文脈で重要だが、製品単位のPMDA確認と院内採用品確認が未完了」と明示する。
...
```text
スルバクタム/アンピシリン OR sulbactam/ampicillin OR sulbactam sodium / ampicillin sodium OR SBT/ABPC|ユナシン|誤嚥性肺炎
```
