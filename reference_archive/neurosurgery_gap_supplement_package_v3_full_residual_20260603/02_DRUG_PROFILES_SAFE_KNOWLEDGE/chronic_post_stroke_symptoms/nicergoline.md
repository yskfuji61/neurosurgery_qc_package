---
drug_key: nicergoline
japanese_name: ニセルゴリン
generic_name: nicergoline
product_examples: "サアミオン錠等"
...
ニセルゴリンは、脳外領域の質問で言及されうる薬剤である。ただし、このファイルは処方推奨ではなく、添付文書・PMDA製品単位情報・院内採用品・保険適用・現在の供給状況を確認させるための安全境界である。
...
脳梗塞後遺症の意欲低下で質問されやすい。急性期治療や認知症万能薬として出してはいけない。
