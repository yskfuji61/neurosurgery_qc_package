---
drug_key: amantadine
japanese_name: アマンタジン塩酸塩
generic_name: amantadine hydrochloride
product_examples: "シンメトレル錠等"
...
アマンタジン塩酸塩は、脳外領域の質問で言及されうる薬剤である。ただし、このファイルは処方推奨ではなく、添付文書・PMDA製品単位情報・院内採用品・保険適用・現在の供給状況を確認させるための安全境界である。
...
腎機能・高齢者・幻覚せん妄・インフルエンザ/パーキンソン病適応との混同が重要。
