...
drug_key: tiapride
japanese_name: チアプリド
generic_name: tiapride hydrochloride
product_examples: "グラマリール錠等"
...
# チアプリド（tiapride hydrochloride）

## Safe RAGでの位置づけ

チアプリドは、脳外領域の質問で言及されうる薬剤である。ただし、このファイルは処方推奨ではなく、添付文書・PMDA製品単位情報・院内採用品・保険適用・現在の供給状況を確認させるための安全境界である。
...
脳梗塞後遺症の行動症状で使われるが、抗精神病薬様副作用、錐体外路症状、QT、嚥下/転倒リスクを分ける必要がある。
