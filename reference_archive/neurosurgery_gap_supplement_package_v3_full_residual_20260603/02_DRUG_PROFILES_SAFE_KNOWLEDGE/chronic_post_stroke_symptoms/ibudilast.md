---
drug_key: ibudilast
japanese_name: イブジラスト
generic_name: ibudilast
product_examples: "ケタスカプセル等"
...
イブジラストは、脳外領域の質問で言及されうる薬剤である。ただし、このファイルは処方推奨ではなく、添付文書・PMDA製品単位情報・院内採用品・保険適用・現在の供給状況を確認させるための安全境界である。
...
脳梗塞後遺症めまいの文脈で質問されやすい。急性期脳梗塞治療薬として出してはいけない。
