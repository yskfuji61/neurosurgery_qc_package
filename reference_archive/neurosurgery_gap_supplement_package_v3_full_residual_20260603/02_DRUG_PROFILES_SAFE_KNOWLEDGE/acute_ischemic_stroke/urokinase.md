---
drug_key: urokinase
japanese_name: ウロキナーゼ
english_name: urokinase
generic_name: urokinase
synonyms: "urokinase|線維素溶解酵素剤"
drug_class: 血栓溶解薬
...
## 1. この薬剤を追加する理由
現代標準ではrt-PA/EVT中心だが、脳血栓症/脳塞栓鑑別・線溶薬出血リスクの安全教育上重要。
...
## 6. 主な参照ソース
- PMDA_UROKINASE_SAFETY_2019: ウロキナーゼ関連 安全対策調査会資料  \
  URL: https://www.pmda.go.jp/files/000232192.pdf  \
  使用箇所: 脳血栓症と脳塞栓症の鑑別、出血性脳梗塞警告、線溶薬安全境界の確認  \
  限界: 安全対策資料。現在の販売名・添付文書・採用状況確認必須。

## 7. PMDA検索クエリ候補

```text
ウロキナーゼ OR urokinase OR urokinase OR urokinase|線維素溶解酵素剤
```
