...
drug_key: edaravone
japanese_name: エダラボン
english_name: edaravone
generic_name: edaravone
synonyms: "ラジカット|Radicut|free radical scavenger"
drug_class: 脳梗塞急性期・脳保護薬
...
## 1. この薬剤を追加する理由
国内脳梗塞急性期で重要。ALS適応と混同しやすく、脳外Vaultでは脳梗塞急性期文脈を明示分離する必要がある。
...
## 6. 主な参照ソース
- PMDA_EDARAVONE_RMP_RADICUT: ラジカット注/点滴静注バッグ RMP  \
  URL: https://www.pmda.go.jp/RMP/www/400315/6eba6676-657f-43cb-a9ad-b00dd4a8b6e6/400315_1190401A1023_006RMP.pdf  \
  使用箇所: エダラボンの脳梗塞急性期適応、投与開始時期、安全性監視文脈の確認  \
  限界: RMPであり添付文書の代替ではない。後発品・剤形差・施設採用品は別確認。

## 7. PMDA検索クエリ候補

```text
エダラボン OR edaravone OR edaravone OR ラジカット|Radicut|free radical scavenger
```
