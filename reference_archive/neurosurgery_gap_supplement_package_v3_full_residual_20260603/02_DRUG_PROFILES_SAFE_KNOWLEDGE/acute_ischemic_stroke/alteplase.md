---
drug_key: alteplase
japanese_name: アルテプラーゼ
english_name: alteplase
generic_name: alteplase recombinant
synonyms: "rt-PA|tPA|アクチバシン|グルトパ"
drug_class: 血栓溶解薬・急性期虚血性脳血管障害
...
## 1. この薬剤を追加する理由
発症時間、画像、除外基準、抗凝固薬、抗アミロイド抗体など安全境界が多く、class扱いは危険。
...
- PMDA_ALTEPLASE_LABEL: アルテプラーゼ 静注用rt-PA製剤 添付文書PDF  \
  URL: https://www.pmda.go.jp/PmdaSearch/iyakuDetail/ResultDataSetPDF/400315_3959402D1035_3_16  \
  使用箇所: 虚血性脳血管障害急性期、発症後4.5時間以内、出血性相互作用、抗アミロイド抗体関連注意の確認  \
  限界: 販売名・版数は必ずPMDA画面で確認。院内プロトコル・rt-PA適正治療指針とセットで扱う。

## 7. PMDA検索クエリ候補

```text
アルテプラーゼ OR alteplase OR alteplase recombinant OR rt-PA|tPA|アクチバシン|グルトパ
```
