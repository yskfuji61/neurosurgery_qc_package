---
drug_key: fludrocortisone
japanese_name: フルドロコルチゾン
english_name: fludrocortisone
generic_name: fludrocortisone acetate
synonyms: "フロリネフ|mineralocorticoid|CSW"
drug_class: 鉱質コルチコイド・低Na/CSW関連
...
## 1. この薬剤を追加する理由
SAH後低Na、CSW文脈で言及される。SIADHとの鑑別を強制するRAG境界が必要。
...
```text
フルドロコルチゾン OR fludrocortisone OR fludrocortisone acetate OR フロリネフ|mineralocorticoid|CSW
```
