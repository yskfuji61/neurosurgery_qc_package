---
drug_key: cryoprecipitate
japanese_name: クリオプレシピテート
english_name: cryoprecipitate
generic_name: cryoprecipitate
synonyms: "クリオ|低フィブリノゲン|fibrinogen source"
drug_class: 血液製剤・低フィブリノゲン補正
...
## 1. この薬剤を追加する理由
大量出血・低フィブリノゲン・DIC/周術期出血で重要。施設運用と輸血部方針依存が大きい。
...
```text
クリオプレシピテート OR cryoprecipitate OR cryoprecipitate OR クリオ|低フィブリノゲン|fibrinogen source
```
