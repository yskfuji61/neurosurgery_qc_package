---
drug_key: vitamin_k
japanese_name: ビタミンK製剤
english_name: vitamin K
generic_name: phytonadione / menatetrenone etc.
synonyms: "フィトナジオン|メナテトレノン|warfarin reversal"
drug_class: ワルファリン反転補助
...
## 1. この薬剤を追加する理由
PCCだけではワルファリン反転の持続性説明が不完全。PCC/FFP/ビタミンKの役割分離が必須。
...
```text
ビタミンK製剤 OR vitamin K OR phytonadione / menatetrenone etc. OR フィトナジオン|メナテトレノン|warfarin reversal
```
