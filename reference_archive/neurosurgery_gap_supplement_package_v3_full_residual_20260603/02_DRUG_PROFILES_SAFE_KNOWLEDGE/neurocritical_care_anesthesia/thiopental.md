---
drug_key: thiopental
japanese_name: チオペンタールナトリウム
english_name: thiopental sodium
generic_name: thiopental sodium
synonyms: "ラボナール|thiopental|barbiturate coma"
...
## 1. この薬剤を追加する理由
難治性ICP/麻酔導入/痙攣重積などで文脈上重要。循環抑制と脳波/ICU管理が必要。
...
```text
チオペンタールナトリウム OR thiopental sodium OR thiopental sodium OR ラボナール|thiopental|barbiturate coma
```
