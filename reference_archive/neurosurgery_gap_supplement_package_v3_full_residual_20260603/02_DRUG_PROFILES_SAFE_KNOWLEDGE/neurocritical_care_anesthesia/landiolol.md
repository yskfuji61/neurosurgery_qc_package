---
drug_key: landiolol
japanese_name: ランジオロール塩酸塩
english_name: landiolol hydrochloride
generic_name: landiolol hydrochloride
synonyms: "オノアクト|ultra-short acting beta blocker"
drug_class: 短時間作用型β1遮断薬
domain: neurocritical_care_circulation
priority: B
...
## 1. この薬剤を追加する理由
周術期頻脈・AF・血圧管理で重要。低血圧/徐脈により脳灌流圧を悪化させうる。
...
1. 「この薬剤はneurocritical_care_circulation文脈で重要だが、製品単位のPMDA確認と院内採用品確認が未完了」と明示する。
...
```text
ランジオロール塩酸塩 OR landiolol hydrochloride OR landiolol hydrochloride OR オノアクト|ultra-short acting beta blocker
```
