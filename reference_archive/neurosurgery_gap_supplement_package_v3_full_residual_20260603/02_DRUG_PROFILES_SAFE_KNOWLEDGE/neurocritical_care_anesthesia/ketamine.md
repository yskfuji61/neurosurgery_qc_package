...
synonyms: "ケタラール|NMDA antagonist"
drug_class: 鎮痛・鎮静・麻酔薬
...
## 1. この薬剤を追加する理由
鎮痛鎮静、気管挿管、重症頭部外傷で議論される。ICPに関する古い禁忌的理解と現代解釈を混同しない。
...
```text
ケタミン OR ketamine OR ketamine OR ケタラール|NMDA antagonist
```
