---
drug_key: nitroglycerin
japanese_name: ニトログリセリン
english_name: nitroglycerin
generic_name: nitroglycerin
synonyms: "ミリスロール|nitric oxide donor"
drug_class: 硝酸薬・降圧/冠血管拡張
...
## 1. この薬剤を追加する理由
周術期・ICU降圧で出る。ICP/脳灌流圧への影響、ニカルジピン等との使い分けが必要。
...
```text
ニトログリセリン OR nitroglycerin OR nitroglycerin OR ミリスロール|nitric oxide donor
```
