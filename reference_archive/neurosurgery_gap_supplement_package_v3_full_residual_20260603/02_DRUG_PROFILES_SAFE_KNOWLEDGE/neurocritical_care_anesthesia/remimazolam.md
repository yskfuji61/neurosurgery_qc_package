---
drug_key: remimazolam
japanese_name: レミマゾラム
english_name: remimazolam
generic_name: remimazolam besylate
synonyms: "アネレム|remimazolam"
drug_class: ベンゾジアゼピン系全身麻酔薬
...
## 1. この薬剤を追加する理由
麻酔・内視鏡/手術鎮静文脈で重要度上昇。ミダゾラム・プロポフォールとの比較で混同しやすい。
...
```text
レミマゾラム OR remimazolam OR remimazolam besylate OR アネレム|remimazolam
```
