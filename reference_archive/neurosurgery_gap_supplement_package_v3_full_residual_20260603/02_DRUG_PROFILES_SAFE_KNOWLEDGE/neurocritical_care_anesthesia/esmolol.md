---
drug_key: esmolol
japanese_name: エスモロール塩酸塩
english_name: esmolol hydrochloride
generic_name: esmolol hydrochloride
synonyms: "ブレビブロック|short acting beta blocker"
drug_class: 短時間作用型β遮断薬
...
## 1. この薬剤を追加する理由
周術期循環管理で文脈上必要。ランジオロールとの国内採用・薬事差を確認。
...
```text
エスモロール塩酸塩 OR esmolol hydrochloride OR esmolol hydrochloride OR ブレビブロック|short acting beta blocker
```
