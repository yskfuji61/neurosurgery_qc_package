---
drug_key: phenobarbital
japanese_name: フェノバルビタール
english_name: phenobarbital
generic_name: phenobarbital
synonyms: "フェノバール|barbiturate antiseizure"
drug_class: 抗発作薬・難治発作
domain: status_epilepticus
priority: A
...
## 1. この薬剤を追加する理由
難治発作・小児/成人の救急文脈で重要。鎮静・呼吸循環抑制・TDMを個別化する必要がある。
...
1. 「この薬剤はstatus_epilepticus文脈で重要だが、製品単位のPMDA確認と院内採用品確認が未完了」と明示する。
...
```text
フェノバルビタール OR phenobarbital OR phenobarbital OR フェノバール|barbiturate antiseizure
```
