...
drug_key: clobazam
japanese_name: クロバザム
english_name: clobazam
generic_name: clobazam
synonyms: "マイスタン|benzodiazepine antiseizure"
drug_class: 抗発作薬・補助療法
...
## 1. この薬剤を追加する理由
慢性補助抗発作薬として重要。急性発作停止薬と混同しない境界が必要。
...
```text
クロバザム OR clobazam OR clobazam OR マイスタン|benzodiazepine antiseizure
```
