...
title: "gap_v3_csf_iih_reference_collision"
...
| Check | Result |
|-------|--------|
| ICP / CSF vs tumor-edema steroid context separated | Yes in boundary hub |
| Facility IIH protocol | **Not confirmed** |
...
Readiness matrix: `reference_archive/neurosurgery_gap_supplement_package_v3_full_residual_20260603/09_MANIFESTS/gap_v3_human_review_readiness_matrix.csv` — filter `collision_id` = `GAP-V3-COLLISION-CSF-IIH-001`.
