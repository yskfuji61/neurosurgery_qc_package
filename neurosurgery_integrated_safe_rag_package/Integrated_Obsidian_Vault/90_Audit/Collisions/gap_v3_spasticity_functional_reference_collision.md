...
title: "gap_v3_spasticity_functional_reference_collision"
...
# Collision: spasticity_functional_neurosurgery
...
| Check | Result |
|-------|--------|
| ITB / botulinum / DBS perioperative notes distinguished | Yes |
| Rehab + functional neurosurgery facility protocol | **Not confirmed** |
...
Readiness matrix: `reference_archive/neurosurgery_gap_supplement_package_v3_full_residual_20260603/09_MANIFESTS/gap_v3_human_review_readiness_matrix.csv` — filter `collision_id` = `GAP-V3-COLLISION-SPASTICITY-FUNCTIONAL-001`.
